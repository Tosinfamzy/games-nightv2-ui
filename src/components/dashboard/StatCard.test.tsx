...
describe('StatCard', () => {
  ...
  describe('Icon Display', () => {
    ...
    it('should not render icon section when icon not provided', () => {
      const { container } = render(<StatCard label="Players" value={10} />)
  ...
  describe('Subtitle Display', () => {
    ...
    it('should render complex subtitle', () => {
      render(
        <StatCard label="Online Players" value={8} subtitle="of 12 total" />,
      )
  ...
  describe('Accessibility', () => {
    it('should have proper semantic structure', () => {
      const { container } = render(<StatCard label="Sessions" value={10} />)
