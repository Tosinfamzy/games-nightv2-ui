...
const GamesMasterContext = createContext<GamesMasterContextValue | undefined>(undefined);
...
export function useGamesMasterContext() {
  ...
  if (!context) {
    throw new Error('useGamesMasterContext must be used within GamesMasterProvider');
  }
  return context;
}
